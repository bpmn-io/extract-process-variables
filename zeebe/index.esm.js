 ...
 */
function createProcessVariable(flowElement, name, defaultScope, definingBo, details) {
 ...
 * @returns {Array<ProcessVariable>}
 */
function getVariablesForScope(scope, rootElement, additionalExtractors = []) {
...
function getVariablesForElement(element, additionalExtractors = []) {
  return getVariablesForScope(getScope$1(element), getRootElement(element), additionalExtractors);
}
